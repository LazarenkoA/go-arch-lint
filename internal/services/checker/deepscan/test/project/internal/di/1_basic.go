...
import (
	"github.com/LazarenkoA/go-arch-lint/internal/pkg/deepscan/test/project/internal/operations"
	"github.com/LazarenkoA/go-arch-lint/internal/pkg/deepscan/test/project/internal/repository"
)
